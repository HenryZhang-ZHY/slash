...
[deployment](/en/self-host/deployment/) for the container image, environment
...
- **Webhook secret**: a random value — this becomes the file pointed at by
...
- [Deployment](/en/self-host/deployment/) — running the server, key rotation, incident
  procedure
